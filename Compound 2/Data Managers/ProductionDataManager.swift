...
extension ProductionDataManager {
    private static func convertPlistDataIntoProductionStruct(_ plistData: Data, for company: String) -> Production? {
        ...
        for (key, value) in plistDict {
            ...
            guard let produceValues = value["produce"] as? NSMutableArray else {
                return nil
            }
...
//            default: //key == name of the commodity like tomatoes or aluminium
//                produceValues = value as? [(year: Int, value: Double)]
//                guard produceValues != nil else { return nil }
//            }
...
extension ProductionDataManager {
    private static let productionDataDirectory = FinancialDataManager.corporateDataDirectory + "/ProductionFigures"
}
